<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/11/template/blocks/blockSlideTop.php
            ...
            <?php if(!empty($v['image_slide'])) { ?>
                <?php if(is_array($v['image_slide'])) { foreach($v['image_slide'] as $k2 => $v2) { ?>
                    <div class="item item <?php if($k2==0) { ?> active <?php } ?>">
                        ...
                        <h3><a href=""><?=$v2['title']?></a></h3>
                        <p class="font-default text-light text-spacing-20 veil reveal-sm-block"><?=$v2['description']?></p>

                        <div class="group-sm"><a class="btn btn-default btn-sm" href="#">learn more</a><a class="btn btn-primary btn-sm" href="#">Request a Quote</a></div>
                        </div>
...
<section class="section-80 section-md-top-65 section-md-bottom-120 bg-dark-blue context-dark section-skew section-skew-wide">
  ...
  <div class="shell text-md-left">
    <h2><i class="fa fa-bus fa-5"></i> Đặt vé online</h2>
