<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/32//common/global_css.php
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main1.css?v=5.5">
<?php } else { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=5.5">
<?php } ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style4.css?v=9.9">
<?php if($web['anvui_id'] == 'TC0Cm1rweVdinjJi' || $web['anvui_id'] == 'TC09m1ql0HQCiixG') { ?>
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main3.css?v=11.3">
