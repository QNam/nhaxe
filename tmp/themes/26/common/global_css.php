<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/26//common/global_css.php
...
<link href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/plugins/slick/slick.css" rel="stylesheet" />

<link href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/plugins/slick/slick-theme.css" rel="stylesheet" />


<?php if($web['anvui_id'] == 'TC09m1ql0HQCiixG') { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main1.css?v=5.3">
<?php } else { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=5.2">
<?php } ?>

<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style4.css?v=7.6">
<?php if($web['anvui_id'] == 'TC09m1ql0HQCiixG') { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style5.css?v=8.2">
<?php } ?>

<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/icon?family=Material+Icons">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/materialize.css">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/header.css?v=1.0">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/bundled.css?v=1.3">
