<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/26//datve/index.php
...
<script src="/themes//14/statics/js/anvui1.js?v=1.<?php echo time() ?>123"></script>
<?php } elseif($web['anvui_id'] == 'TC09m1ql0HQCiixG') { ?>
