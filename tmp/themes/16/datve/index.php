<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/16//datve/index.php
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/styledv2.css?v=4.7">
...
<script src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/js/anvui.js?v=1.4.5<?php echo time() ?>"></script>
