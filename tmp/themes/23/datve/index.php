<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/23//datve/index.php
...
<script src="http://testnhaxe.nhaxe.vn/themes//14/statics/js/anvui1.js?v=1.<?php echo time() ?>123"></script>
<?php } else { ?>
<script src="http://testnhaxe.nhaxe.vn/themes//14/statics/js/anvui.js?v=1.<?php echo time() ?>123"></script>
<?php } ?>
