<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/23//home/index.php
    ...
    <div class="wrapper">
        ...
        <?php } else { ?>
        <h2><span class="hot">Đội xe</span></h2>
    </div>
    <?php } ?>
    <div id="slider_pro">
                    ...
                    <div class="w-item effect_up" style="animation-duration: 0.9s;">
                        <div class="i-image">
                            <a href="<?=$v['link']?>" tabindex="0">
                                      <?php if($v['listImages']['0'] != "0" && isset($v['listImages']['0'])) { ?>
                                        ...
                                        <img src="<?=$v['listImages']['0']?>" class="img-responsive" alt="<?=$v['routeName']?>" alt="<?=$v['routeName']?>"  />
                        ...
                        <div class="i-desc">
                            <div class="w-desc" style="    text-align: center;">
                                ...
                                <div class="i-content">
                                    <p class="card-content" style="color: #c00;">Giá vé: <?=$v['price']?></p>
                                </div>
                            </div>
                        </div>
                    </div>
