<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/23//common/global_css.php
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=4.4">
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style6.css?v=8.2">
