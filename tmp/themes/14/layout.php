<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/14//layout.php
                     * @Author Quang Chau Tran (quangchauvn@gmail.com)
                     */
                    if(!defined('BNC_CODE')) {
                        exit('Access Denied');
                    }
                    ?><?php if($web['anvui_id'] !== 'TC03m1MSnhqwtfE') { ?>
...
<body class="home page-template page-template-tpl-homepage page-template-tpl-homepage-php page page-id-1629 ">
<div id="fb-root"></div>
