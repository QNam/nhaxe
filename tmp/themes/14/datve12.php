<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/14//datve12.php
            ...
            <div class="row" style="margin-bottom: -15px;">
                <div class="clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="dropdown">
                          <div id="myDropdown" class="dropdown-content">
                            <input type="text" name="startPoint" class="form-control"  id="startPointD" onkeyup="filterFunction()" autocomplete = "off">
                            <div class="showDropStartPoint" style="display: none;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="dropdown">
                          <div id="myDropdownEnd" class="dropdown-content">
                            <input type="text" name="endPoint" class="form-control"  id="endPointD" onkeyup="filterFunctionEndPoint()" autocomplete="off">
                            <div class="showDropEndPoint" style="display: none;">
