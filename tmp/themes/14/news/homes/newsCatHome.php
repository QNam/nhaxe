<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/14/news/homes/newsCatHome.php
...
.av-info-news #slider_new2 .item .i-desc .w-desc {
    height: auto !important;
    padding-bottom: 15px;
}
.av-info-news #slider_new2 .item .i-desc .i-title h3{
    margin: 0px;
}
.av-info-news #slider_new2 .item .w-item {
    margin-bottom: 15px;
    border-bottom: 1px solid #ddd;
    padding: 0px;
}
.av-info-news #slider_new2 .item .i-desc{
    padding: 0px;
}
</style>
<div class="container">
        ...
        <div class="wrap_news">
            <div class="div_title">
                ...
                <div id="slider_new2" class="w_effect_up">
                    <div class="item row" style="margin-left: -15px; margin-right: -15px;">
                        <?php $i=0 ?>
                        <?php if(is_array($data['content']['home_cat']['0']['content_news'])) { foreach($data['content']['home_cat']['0']['content_news'] as $k => $v) { ?>
                        <?php if($i < 4) { ?>
                        

                        <div class="w-item col-md-6 " style="padding-left: 15px; padding-right: 15px;">
                            <div class="i-image" >
                                <a  href="<?=$v['link']?>">
                        ...
                        <div class="w-item col-md-12">
                            ...
                            <div class="i-desc">
                                <div class="w-desc">
                                    <div class="i-title">
                                        <h3 itemprop="headline"><a href="<?=$v['link']?>"><?=$v['title']?></a></h3></div>
                                    <div class="i-content" itemprop="description"><?php echo cutString($v['short'],0,200); ?></div>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
...
<div class="wp-news-cat-t" style="margin-top: 30px;">
    <div class="container">
        <div class="av-info" style="height: 484px;">
            <div class="div_title">
                <h2><?=$data['content']['home_cat']['1']['title']?></h2>
            </div>
            <div class="list_info">
                <div id="slider_new2" class="w_effect_up">
                    <div class="item row">
                ...
                <div class="item row">
                    ...
                    <div class="w-item col-md-6">
                        <div class="i-image" >
                            <a  href="<?=$v['link']?>">
                              <img <?php  echo loadImage($v['img'],'none','570','290',true); ?>alt="<?=$v['title']?>" />
                              <span class="date"><meta itemprop="datePublished" content="2018-02-21" /><span><?=$v['create_day']?></span><?=$v['create_md']?></span>
                            </a>
                        </div>
                        <div class="i-desc">
                            <div class="w-desc">
