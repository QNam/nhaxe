<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/31//common/header_meta.php
                    ...
                    ?><?=$web['ga']?>
<!--<base s_name="trungthanh" href="<?=$web['home_url']?>" extention="<?=$web['dotExtension']?>" />-->
...
<!-- Event snippet for call 996 conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-740125116/4mouCIjrw7kBELzT9eAC'});
</script>
<!-- Global site tag (gtag.js) - Google Ads: 740125116 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-740125116"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-740125116');
</script>
