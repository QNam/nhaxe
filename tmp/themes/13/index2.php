<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/13//index2.php
                ...
                <div class="col-md-8">
                    <div id="steps">
                        <ul class="list-step clearfix">
                            ...
                            <li class="active">Chi tiết vé<span></span></li>
                            <li>Thanh toán <span></span></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-12 customer-info">
                                ...
                                <div class="total-title">
                                    ...
                                    <div class="total-inside row">
                                        <div class="col-md-12">
                                            Ghế đã chọn: <span class="seatlist" id="ghedi">Chưa chọn</span> <br>
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="select-seat">
                                ...
                                <div class="row form-customer">
                                    <div class="col-md-12">
                                        <label for="fullname" style="display: none;">Họ và tên (<span class="required">*</span>)</label>
                                        <input type="text" placeholder="Họ và tên" class="form-control" name="fullname" id="fullname" autofocus required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="phoneNumber" style="display: none;">Số điện thoại (<span class="required">*</span>)</label>
                                        <input type="text" placeholder="Số điện thoại" class="form-control" name="phoneNumber" id="phoneNumber" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="phoneNumber" style="display: none;">Email</label>
                                        <input type="email" placeholder="Email" class="form-control" name="email" id="email">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="phoneNumber" style="display: none;">Ghi chú</label>
                        ...
                        <div class="col-md-12 payment-dialog">
                            ...
                            <div class="payment-form">
                                <div class="radio">
                                    ...
                                    <div class="g-recaptcha" data-sitekey="6Lfj5GgUAAAAAMrOS2iyOUIfdz02Ox0XJgbqbe4t"></div>
                                </div>
                                <center>
...
<link rel="stylesheet" type="text/css" href="http://testnhaxe.nhaxe.vn/themes//13/statics/css/style3.css?v=3.9">
<script src="http://testnhaxe.nhaxe.vn/themes//13/statics/js/anvui.js?v=1.4.6<?php echo time() ?>"></script>
