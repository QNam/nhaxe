<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/13//datve/index.php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ttck-skh ">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="box-tt-ck">
                                <div class="name-tdsd">Người thụ hưởng:</div> <div class="content-dds">Công ty cổ phần đầu tư AVI</div>
                                <div class="name-tdsd">Số tài khoản:</div> <div class="content-dds">117002671653</div>
                                <div class="name-tdsd">Ngân hàng:</div> <div class="content-dds">Vietinbank</div>
                                <div class="name-tdsd">Chi nhánh:</div> <div class="content-dds">7 HCM</div>
                            </div>
                        </div>
...
<?php if($web['anvui_id'] === 'TC04J1GKSSth4UY' || $web['anvui_id'] === 'TC0Ah1r7bCvzRlpF'  || $web['anvui_id'] === 'TC0BA1rJ3ah7wdMl' || $web['anvui_id'] === 'TC07C1pjfHQtyduK' || $web['anvui_id'] == 'TC0Bp1rZFPJNRYty' || $web['anvui_id'] == 'TC0CK1rlUyn1qquy' || $web['anvui_id'] == 'TC05wM7dDRQSo6' || $web['anvui_id'] == 'TC05wM7dDRQSo6') { ?>
<script src="/themes/14/statics/js/anvui2.js?v=1.<?php echo time() ?>123"></script>
<?php } elseif($web['anvui_id'] === 'TC08Z1qHHZBxlNLt') { ?>
<script src="/themes/14/statics/js/anvui3.js?v=1.<?php echo time() ?>123"></script>
<?php } else { ?>
...
<script>
    ...
    $(".click-back").append('<a href="/'"><i class="fa fa-chevron-left" aria-hidden="true"></i> Quay lại</a>')
