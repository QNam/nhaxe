<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/13//datve/datve.php
    ...
    body {
        ...
        background-size: auto 100%; dshfkdfh*/
    }
...
<script src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/js/anvui.js?v=1.4.6<?php echo time() ?>"></script>
