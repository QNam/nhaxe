<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/13//category/category_details.php
...
<?php if($web['anvui_id'] == TC0CK1rlUyn1qquy AND $data['content']['categoryDetail']['id'] == 145) { ?>
<script type="text/javascript">
    var isMobile = {
        Android: function() {
            return navigator.userAgent.match(/Android/i);
    ...
    var urlAndroid = 'https://play.google.com/store/apps/details?id=vn.anvui.hahai';
    var urlIOs = 'https://itunes.apple.com/app/id1481156740';
...
<?php } ?>
<?php if($web['anvui_id'] == TC0Ah1r7bCvzRlpF AND $data['content']['categoryDetail']['id'] == 71) { ?>
<script type="text/javascript">
var isMobile = {
        Android: function() {
            return navigator.userAgent.match(/Android/i);
    ...
    var urlAndroid = 'https://play.google.com/store/apps/details?id=vn.anvui.gonowbus';
    var urlIOs = 'https://itunes.apple.com/app/id1467726665';
