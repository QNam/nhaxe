<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/24//category/category_details.php
...
<?php } ?>
<?php if($web['anvui_id'] == 'TC0A31qrgPVJBW3a' AND $data['content']['categoryDetail']['id'] == 52  ) { ?>
<script type="text/javascript">
    var isMobile = {
        Android: function() {
            return navigator.userAgent.match(/Android/i);
    ...
    var urlAndroid = 'https://play.google.com/store/apps/details?id=vn.anvui.trungthanh';
    var urlIOs = 'https://itunes.apple.com/app/id1460760852';
