<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/7//category/category_details.php
...
<?php if($web['anvui_id'] == 'TC0Bi1rWXg3hO6JR' AND $data['content']['categoryDetail']['id'] == 154) { ?>
<script type="text/javascript">
    ...
    var urlAndroid = 'https://play.google.com/store/apps/details?id=vn.anvui.tuannga';
    var urlIOs = 'https://itunes.apple.com/app/id1482749316';
