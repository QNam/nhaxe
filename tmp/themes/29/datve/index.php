<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/29//datve/index.php
            ...
            <div class="modal-body ttck-skh ">
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box-tt-ck">
                                <div class="name-tdsd">Người thụ hưởng:</div> <div class="content-dds">QUÁCH THU NGA</div>
                                <div class="name-tdsd">Số tài khoản:</div> <div class="content-dds">106868524788</div>
                                <div class="name-tdsd">Ngân hàng:</div> <div class="content-dds">viettinbank</div>
                                <div class="name-tdsd">Chi nhánh:</div> <div class="content-dds">TP. Vinh - Nghệ An</div>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="box-tt-ck">
                                <div class="name-tdsd">Người thụ hưởng:</div> <div class="content-dds">CÔNG TY TNHH MTV KS DL VẬN TẢI VŨ LINH</div>
                                <div class="name-tdsd">Số tài khoản:</div> <div class="content-dds">070053208256</div>
                                <div class="name-tdsd">Ngân hàng:</div> <div class="content-dds">Sacombank</div>
                                <div class="name-tdsd">Chi nhánh:</div> <div class="content-dds">Cần Thơ</div>
                            </div>
                        </div>
