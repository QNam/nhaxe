<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/20/news/homes/newsTravel.php
...
<div class="container">
    ...
    line-height: 40px;
    font-family: Roboto Condensed, sans-serif;"> Dịch vụ cho thuê xe</h2>
        </div>
        <div class="row">
            <div class="owl-carousel owl-theme travel-list">
                ...
                <div class="item-travel">
                    <a href="<?=$v['link']?>">
                        <div class="image">
                            <img src="<?=$v['thumb']?>" class="img-responsive" style="height: 170px;" alt="<?=$v['title']?>">
                            <div class="promotion">
                                <?=$v['label_name']?>
                            </div>
                        </div>
