<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/20//common/position_bottom.php
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $('#returnDate').val($.format.date(new Date(), "dd/MM/yyyy"));
...
<?php } elseif($web['anvui_id'] === 'TC0A31qrgPVJBW3a') { ?>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://dobody-anvui.appspot.com/point/getlist',
            dataType: "json",
            ...
            success: function(data) {
                ...
                $.each(provinceData, function(index, val) {
                    ...
                    if(val.province == val.pointName ){
                      $('#provideId').append("<option value='" + val.pointId + "'>" + val.pointName + "</option>");
                      $('#diemdi').append('<li id="'+val.pointId+'"> <a class="dropdown-item "  data-id="'+ val.pointId +'" data-name="'+ val.pointName +'" onclick="chondiemdi(this)">'+ val.pointName +'</a> <ul class="cl'+val.pointId+'"></ul> </li>');
                      $('#diemden').append('<li  id="'+val.pointId+'"> <a class="dropdown-item" data-id="'+ val.pointId +'" data-name="'+ val.pointName +'" onclick="chondiemden(this)">'+ val.pointName +'</a> <ul class="cl'+val.pointId+'"></ul> </li>');
                    }
                ...
                $.each(provinceData, function(index, v) {
                    ...
                    if(v.province == "Hà Nội"){
                        $("#diemdi .clP0A71qtIbBWTw0N").append('<li ><a class="dropdown-item" data-id="'+ v.pointId +'" data-name="'+ v.pointName +'" onclick="chondiemdi(this)">'+ v.pointName +'</a></li>')
                        $("#diemden .clP0A71qtIbBWTw0N").append('<li ><a class="dropdown-item" data-id="'+ v.pointId +'" data-name="'+ v.pointName +'" onclick="chondiemden(this)">'+ v.pointName +'</a></li>')
                    }

                    if(v.province == "Quảng Ninh"){
                        $("#diemdi .clQninh").append('<li ><a class="dropdown-item" data-id="'+ v.pointId +'" data-name="'+ v.pointName +'" onclick="chondiemdi(this)">'+ v.pointName +'</a></li>')
                        $("#diemden .clQninh").append('<li ><a class="dropdown-item" data-id="'+ v.pointId +'" data-name="'+ v.pointName +'" onclick="chondiemden(this)">'+ v.pointName +'</a></li>')
                    }
