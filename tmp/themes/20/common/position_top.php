<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/20//common/position_top.php
         ...
         <div class="container-fluid">
            ...
            <div class="" id="bs-example-navbar-collapse-1">
              ...
              <div class="v2_bnc_language">
                  <ul>
                      <?php if(!empty($_B['language'])) { ?>
                        <?php if(is_array($_B['language'])) { foreach($_B['language'] as $k => $v) { ?>
                        <li class="<?php if($i==0) { ?>active<?php } ?>"><a class="flag_language" data-language="<?=$v['code']?>" title="<?=$v['name']?>" href="javascript:void(0);"><img src="<?=$web['static_temp']?><?=$web['temp']?>/statics/flags/<?=$v['image']?>" alt="<?=$v['name']?>"/></a></li>
                        <?php } } ?>
                      <?php } ?>
                      <input type="hidden" id="langRedirectUrl" value="https://interbuslines.com/"/>
                  </ul>
              </div>
              <?php if($web['anvui_id'] == 'TC0BO1rObet9WJXn') { ?>
              <div class="down-app-d"><a href="https://apps.apple.com/vn/app/id1472958144?l=vi"><img alt="" src="https://interbuslines.com/images/appstore.png" ></a><a href="https://play.google.com/store/apps/details?id=vn.anvui.customer&amp;hl=en_US"><img alt="" src="https://cdn.anvui.vn/media/2829/51045529_1942901592444652_3456868977249091584_n.png" ></a></div>
              <?php } ?>

              <?php if($web['anvui_id'] == 'TC0A31qrgPVJBW3a') { ?>
                <div class="topHotline" style="float: right;margin-top: 6px;">
                    <ul>
                        <li style="color: #c00">Tổng đài:<span class="phone" style="color: #c00"><?=$web['info']['phone']?></span></li>
                    </ul>
                </div>
