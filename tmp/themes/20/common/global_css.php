<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/20//common/global_css.php
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=6.2">
<?php } else { ?>
<link rel="stylesheet" href="/themes/25/statics/css/main.css?v=5.7">
<?php } ?>


<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style4.css?v=8.4">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style5.css?v=11.8">


<?php if($web['anvui_id'] == 'TC0BO1rObet9WJXn' || $web['anvui_id'] == 'TC0Ah1r7aBgqH7jX' || $web['anvui_id'] == 'TC0A31qrgPVJBW3a' || $web['anvui_id'] == 'TC1OHntfnujP') { ?>

<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main3.css?v=12">

<?php } ?>

<?php if($web['anvui_id'] == "TC0A31qrgPVJBW3a") { ?>
<link rel="stylesheet" type="text/css" href="/themes/19/statics/css/style5.css?v=10.4">
<?php } ?>
