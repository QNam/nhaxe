<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/25//datve/index.php
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body ttck-skh ">
                ...
                <?php if($web['anvui_id'] == 'TC09m1ql1mnbOd5x') { ?>
                <div class="row">
                    
                        <div class="col-md-8 col-md-offset-2">
                            <div class="box-tt-ck">
                                <div class="name-tdsd">Người thụ hưởng:</div> <div class="content-dds">Trần Đăng Huy</div>
                                <div class="name-tdsd">Số tài khoản:</div> <div class="content-dds">54010000726117</div>
                                <div class="name-tdsd">Ngân hàng:</div> <div class="content-dds">BIDV</div>
                                <div class="name-tdsd">Chi nhánh:</div> <div class="content-dds">Quảng Trị</div>
                            </div>
                        </div>
