<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/25//layout/layout_default.php
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <img src="<?=$web['static_temp']?><?=$web['temp']?>/statics/images/km.png" style="width: 100%" class="img-responsive img-ads" alt="">
            </div>
        </div>
    </div>
</div>
