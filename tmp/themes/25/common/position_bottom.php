<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/25//common/position_bottom.php
...
<footer id="footer">
  ...
  <div class="content-container">
    <span>Theo dõi tin tức từ Đồng Hành Group </span>

      <a target="__blank" href="https://www.facebook.com/donghanhlimousine/" class="social-media-banner__icon">
    ...
    <div class="footer__background">
      <div class="footer__menu">
        <ul>
            ...
            <li><a href="<?=$v['link']?>"  class=""><?=$v['namemenu']?></a></li>
            <?php } } ?>
      ...
      <div class="footer__copyright"> @ 2019 Dong Hanh Goldman Copyright. All Rights Reserved.  <br><br></div>
    </div>
