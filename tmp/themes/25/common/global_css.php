<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/25//common/global_css.php
...
<?php } else { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=5.4">
<?php } ?>
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main2.css?v=4.0">


<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />

<!-- <link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/js/jquery-confirm-v3.3.4/css/jquery-confirm.css"> -->
...
.text-right.pr0.col-md-3.col-sm-3.col-xs-2.col-lg-2 h6 {
    color: #c00;
    font-weight: bold;
    font-size: 15px;
}
