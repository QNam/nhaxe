<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/3//contact/contact.php
...
<div class="f-module-page">
  <div class="f-module-page-title padding-10"> <span class="title"><?php echo lang('title_heading');?></span> </div>
  <div class="f-module-page-body padding-10">
    ...
    <div class="f-contact-page">
      ...
      <div class="f-contact-form row">
       ...
       <div class="col-md-6 col-centered no-padding">
