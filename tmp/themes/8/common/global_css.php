<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/8//common/global_css.php
...
<!-- Include js plugin -->
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=4.8">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/theme-pink.css?v=3.5">
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style1.css?v=5.6">
