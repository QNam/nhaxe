<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/8/news/homes/newsTravel.php
...
<div class="row">
    <div class="col-md-12" style="margin-bottom: 30px;">
        ...
        <div class="owl-carousel owl-theme travel-list">
            ...
            <div class="item-travel-d">
                <div class="item-travel">
                    <a href="<?=$v['link']?>">
                        <div class="image">
                            <img src="<?=$v['thumb']?>" class="img-responsive"  alt="<?=$v['title']?>" style="height: 239px;">
                            <div class="promotion">
                                <?=$v['label_name']?>
                            </div>
                        </div>
