<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/12//common/position_bottom.php
  ...
  <div class="brand">
    <div class="skyline clearfix">
      ...
      <div class="bus-img">
        <img style="opacity: 0.3; filter: alpha(opacity=30);" src="http://ducdoanh.nhaxe.vn/themes/6/statics/imgs/banh-xe.gif">
      </div>
    </div>
  </div>
</div>
