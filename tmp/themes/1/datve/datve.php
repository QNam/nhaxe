<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/1//datve/datve.php
        ...
        <div class="f-center-module">
                ...
                <form class="form-horizontal" id="formsearch">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <select class="form-control" name="startPointId" id="startPointId" style="margin-top: 7px;">
                            ...
                            <option value="<?=$v['pointId']?>" <?php if($data['content']['startPointId']==$v[ 'pointId' ]) { ?>selected<?php } ?>><?=$v['pointName']?> </option> <?php } } ?> </select> </div> <div class="col-md-3 col-sm-3 col-xs-6">
                                <select class="form-control" name="endPointId" id="endPointId" style="margin-top: 7px;">
                                    <option value="0">Điểm đến</option>
                                    <?php if(is_array($data['content']['listPoint'])) { foreach($data['content']['listPoint'] as $k => $v) { ?>
                                    <option value="<?=$v['pointId']?>" <?php if($data['content']['endPointId']==$v[ 'pointId' ]) { ?>selected<?php } ?>><?=$v['pointName']?> </option> <?php } } ?> </select> </div> <div class="col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group" style="margin-top: 7px;">
                                            <input type="text" name="date" value="<?=$data['content']['date']?>" class="form-control" id="datetimepicker" placeholder="Chọn ngày">
                                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6">
            ...
            <div class="f-center-body listchuyen">
                ...
                <div class="listchuyen row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6 chuyendi" data-route="<?=$v['routeId']?>" data-id="<?=$v['tripId']?>" data-scheduleId="<?=$v['scheduleId']?>" data-getInPointId="<?=$v['getInPointId']?>" data-getOffPointId="<?=$v['getOffPointId']?>" data-getInTime="<?=$v['getInTime']?>" data-ticketPrice="<?=$v['ticketPrice']?>" data-companyStatus="<?=$v['companyStatus']?>" data-startDate="<?=$v['startDate']?>">
                        <div class="showchuyen">
                            <img src="https://www.anvui.vn/themes/icon/iConAnVuiVang.png" />
                ...
                <?php } else { ?>
                <center>
                    <h2>Hãy chọn Điểm đi, Điểm đến và thời gian!</h2>
                </center>
                <?php } ?>
            </div>
            <script type="text/javascript">
            ...
            { if <?=$data['content']['khuhoi']['khuhoi']?> == 1 }
            ...
            tongtienve = <?=$data['content']['khuhoi']['tongtien']?>; {
                ...
                function chonghe(id) {
                    ...
                    { if <?=$data['content']['companyId']?> == 'TC1OHmbCcxRS' }
                    ...
                    function checknumbaby(value) {
                        ...
                        { if <?=$data['content']['route']['childrenTicketRatio']?> != 0 }
                        ...
                        function hoanthanh() {
                            ...
                            $.ajax({
                                    ...
                                    var ghe = ghechuyendi.split(','); ghe.splice(-1, 1);
                                    /*Chuyen di*/
                                    $.ajax({
                                        type: 'POST',
                                        url: 'http://demo.nhaxe.vn/dat-ve?sub=order',
                        ...
                        <div class="panel-body transaction" style="padding: 10px;">
                            <div class="box-thongtin row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="phoneNumber" id="phoneNumber" class="form-control no-spinners" placeholder="Số điện thoại">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                                    <div class="col-sm-9">
                                        <input type="email" name="email" id="txtEmail" class="form-control no-spinners" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Số người lớn</label>
                                    <div class="col-sm-2">
                                        <input type="text" style="width: 93px;" id="numberMan" name="numberMan" class="form-control" value="" readonly>
                                    </div>
                                    <label for="inputEmail3" class="col-sm-1 control-label"></label>
                                    <label for="inputEmail3" class="col-sm-3 control-label">Số trẻ em</label>
                                    <div class="col-sm-2">
                                        <input type="text" style="width: 93px;" name="numberBayby" id="numberBayby" class="form-control" value="0" min="0" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-9">
