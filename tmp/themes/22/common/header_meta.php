<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/22//common/header_meta.php
                    ...
                    ?><?=$web['ga']?>
<!--<base s_name="dananh" href="<?=$web['home_url']?>" extention="<?=$web['dotExtension']?>" />-->
...
<meta property="og:image" content="<?=$web['static_upload']?><?=$data['head']['ogimage']?>"/>
