<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/22//home/index.php
    ...
    <video id="video"  class="video" width="100%" loop="true" autoplay="true" playsinline muted>
    <source src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/DanAnh/video/home-video-square.mp4" type="video/mp4" />
    </video>
</div>
...
<div class="home-cta">
    ...
    <a href="dat-ve?routeId=R08Y1qGtOdpzRoX" class="my-btn">Đặt chỗ ngay</a>
</div>

<section class="intro">
<div class="my-container">
    <div class="title-block">
        <span class="oversize-p">Công ty TNHH Du lịch và Vận tải</span>
        <h1 class="oversize-h">Đan Anh</h1>
    </div>
    
    <p class="wide-area-p">Với đội ngũ lái xe nhiều kinh kiệm được tuyển chọn kỹ lưỡng cùng với đội xe Huyndai Solati Limousine SkyBus XLL đời mới; chúng tôi hân hạnh cung cấp cho quý khách những trải nghiệm sang trọng và tuyệt vời nhất trên cung đường Sài Gòn - Đà Lạt.
    </p>
    
    <p>Đặt chỗ qua hotline:</p>
    <a href="tel:<?=$web['info']['phone']?>" title="Hotline">
    <div class="symbol-group">
        <img  src="http://dananhlimousine.vn/themes//22/statics/DanAnh/svg/hotline-icon.svg" />
        <span class=" text oversize-h"><?=$web['info']['phone']?></span>
    </div>
    </a>
</div>
</section>
    ...
    <div class="tour-container">
        <ul class="tour-list">
            <?php if(is_array($data['content']['chuyen'])) { foreach($data['content']['chuyen'] as $k => $v) { ?>
                ...
                <li class="tour-item">
                    <h2 class="tour-name"><?=$v['routeName']?></h2>
                    <div class="tour-info">
                        <p>
                        <b>Đan Anh Limousine</b><br>
                        Giá chỉ từ: <span> <?=$v['price']?> </span>
                        </p>
                        <a class="transition" href="<?=$v['link']?>">Chọn ngày</a>
...
<section class="booking-method">
    <div class="my-container">
        <div class="title-block">
            <h1>3 cách đặt chỗ đơn giản:</h1>
        </div>
        
        <div>
            <ul class="column-list-3">
                <li class="item">
                    <img src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/DanAnh/svg/earth-icon.svg">
                    <h2>Đặt trực tuyến qua web/app</h2>
                    <p>Không cần đến đại lý. <br>Nhanh chóng, tiện lợi và tiết kiệm nhất.</p>
                </li>
                
                <li class="item">
                    <img src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/DanAnh/svg/hotline-icon.svg">
                    <h2>Đặt qua hotline</h2>
                    <p class="oversize-h"><?=$web['info']['phone']?></p>
                </li>
                
                <li class="item">
                    <img src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/DanAnh/svg/home-icon.svg">
                    <h2>Đặt tại văn phòng</h2>
                    <p>Đến các đại lý liên kết của Đan Anh<br />để đặt chỗ trực tiếp</p>
                </li>
            </ul>
        </div>
    </div>
