<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/22//datve/index.php
...
<script src="http://dananhlimousine.vn/themes/22/statics/js/anvui1.js?v=1.<?php echo time() ?>123"></script>
<?php } else { ?>
<script src="http://dananhlimousine.vn/themes//22/statics/js/anvui.js?v=1.<?php echo time() ?>123"></script>
<?php } ?>
