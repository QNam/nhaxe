<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/2//datve/datve.php
    ...
    height: auto;
      ...
      <div class="f-center-body" id="chonghe" style="display:none">
        ...
        <?php if($data['content']['route']['childrenTicketRatio'] != 0) { ?> 
          <i style="color:red;">* Trẻ em vẫn được tính chỗ và giá vé bằng <?=$data['content']['route']['childrenTicketRatio']?>% vé người lớn. </i> 
        <?php } ?>
        <br />
