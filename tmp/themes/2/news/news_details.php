<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/2//news/news_details.php
...
<div class="clearfix"></div>
      ...
      <?php if(isset($data['content']['newsOther']['news'])) { ?>
       ...
       <section class="section-90 section-md-111 bg-zircon">
                    <div class="shell">
                        <h2 class="text-bold"><?php echo lang('news_cat');?></h2>
...
<section class="section-90 section-md-111 bg-zircon">
                    <div class="shell">
                        <h2 class="text-bold"><?php echo lang('related_news');?></h2>
                        <hr class="divider bg-chathams-blue">
