<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/15//common/header_meta.php
                    ...
                    ?><?=$web['ga']?>
<!--<base s_name="testnhaxe" href="<?=$web['home_url']?>" extention="<?=$web['dotExtension']?>" />-->
<base id="TC03j1IanqGKIUS"/>
