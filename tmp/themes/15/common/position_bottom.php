<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/15//common/position_bottom.php
...
<!--Module waterbus-->
<script src="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/plugins/web-waterbus/js/waterbus/waterbus.module.js?v=3.3"></script>
<!--End waterbus-->
    ...
    <div class="footer-bottom" >
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                    <h3 class="fttt" style="    width: 100%;">Hệ thống ga tàu thủy SAIGONWATERBUS</h3>
                    
                        <div class="col-6 item-httt">
                            <p>Ga tàu thủy Bạch Đằng - Bach Dang Station
10B Tôn Đức Thắng - Công Trường Mê Linh,
Phường Bến Nghé, Quận 1, TP.HCM</p>
                        </div>
                        <div class="col-6 item-httt">
                            <p>Ga tàu thủy Bình An - Binh An Station
Đường 20, Phường Bình An, Quận 2, TP.HCM</p>
                        </div>
                        <div class="col-6 item-httt">
                            <p>Ga tàu thủy Thanh Đa - Thanh Da Station
Công viên Bờ sông Lô 1 Cư Xá Thanh Đa,
Phường 27, Quận 2, TP.HCM</p>
                        </div>
                        <div class="col-6 item-httt">
                            <p>Ga tàu thủy Hiệp Bình Chánh
Đường 10, Phường Hiệp Bình Chánh
Quận Thủ Đức, TP.HCM</p>
                        </div>
                        <div class="col-6 item-httt">
                            <p>Ga tàu thủy Linh Đông - Linh Dong Station
Đường 36, Phường Linh Đông
Quận Thủ Đức, TP.HCM</p>
                        </div>
                    </div>
                ...
                <div class="col-6">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <h3 class="fttt">Theo dõi chúng tôi</h3>
                            <ul>
                                <li class="item-sd facebookd">
                                    <a href=""><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
                                </li>
                                <li class="item-sd youtubed">
                                    <a href=""><i class="fa fa-youtube-square" aria-hidden="true"></i></a>
                                </li>
                                <li class="item-sd instagramd">
                                    <a href=""><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <h3 class="fttt">Hình ảnh nổi bật</h3>
                            <ul class="img-hot">
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/26/02/13/1540520013_saigon-waterbus-1.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/24/09/14/1540372487_dji_0006.mov_snapshot.jpg"></a></li>
                                <li><a href="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/25/04/44/1540442695_saigon-waterbus-tau-buyt-tren-song.jpg"><img src=""></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/25/04/01/1540440071_check-in-saigon-waterbus.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/24/08/53/1540371235_buyt-song.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/24/09/14/1540372487_dji_0006.mov_snapshot.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/24/09/04/1540371896_0-02-06-3b79399185cf65168bc4c647d9566252bda1efd475.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/24/09/14/1540372487_dji_0006.mov_snapshot.jpg"></a></li>
                                <li><a href=""><img src="http://cdn.anvui.vn/uploadv2/web/31/3178/news/2018/10/26/02/13/1540520013_saigon-waterbus-1.jpg"></a></li>
                            </ul>
                        </div>
...
<script type="text/javascript">
    $('.bookNow').click(function() {
      $('html, body').animate({
        scrollTop: $(".wp-forrmdv").offset().top
      }, 1000)
    }), 
                ...
                $.ajax({
                    ...
                    success : function (res) {
                        ...
                        if(option ==="3"){
                            ...
                            $.ajax({
                                url : 'https://nha-tau-anvui.appspot.com/ePay/',
                                type: "post",
                                dataType:"json",
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        url: 'https://nha-tau-an-vui.appspot.com/point/getList',
        dataType: "json",
        data: JSON.stringify({ companyId: 'TC03j1IanqGKIUS', count: 1000, pointType : 1 }),
        success: function(data) {
...
<script type="text/javascript">
    ...
    //         type: 'red',
    //         typeAnimated: true,
    //         content: 'Tính năng đặt vé đang được cập nhật',
    //     });
    // })

    $('#seachWaterbus').on('click', function() {
