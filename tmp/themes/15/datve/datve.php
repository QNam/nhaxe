<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/15//datve/datve.php
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://nha-tau-anvui.appspot.com/point/get_province_and_point',
            dataType: "json",
    ...
    function getAds() {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://nha-tau-anvui.appspot.com/popup/get-list',
            dataType: "json",
            async:false,
