<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/15/template/blocks/blockSlideTop.php
...
<div class="slide-2">
    <div class="">
                    ...
                    <div class="itemTouris">
                        ...
                        <div class="jeg_postblock_content">
                            ...
                            <div class="jeg_post_info"> 
                                <h3 class="jeg_post_title"> <a href=""><?=$v2['title']?></a> </h3> 
        ...
        <a href="" class="viewDetail">Xem chi tiết <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
        <a href="javascript:void(0)" class="bookNow">Book now <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
    </div>
</div>
<?php } ?>