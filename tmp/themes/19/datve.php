<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/19//datve.php
...
<div class="container" style="margin-top: 10px;">
    ...
    <h3 class="heading">
        <ul>
            <li class="clickChangeRouterId active" data-routerid="R08G1q9qEWNnV4t">Hạ Long -Sân Bay Vân Đồn</li>
            <li class="clickChangeRouterId" data-routerid="R08G1q9q2hIeqJj">Sân Bay Vân Đồn - Hạ Long</li>
        </ul>
    </h3>
    <div class="clearfix"></div>
    <div class="route-list datve-home" style="margin-top: 0px">
        <form action="bussanbay" id="search-form">
