<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/19//common/header_meta.php
                    ...
                    ?><?=$web['ga']?>
<!--<base s_name="adminphucxuyen" href="<?=$web['home_url']?>" extention="<?=$web['dotExtension']?>" />-->
...
<meta property="og:image" content="https://cdn.anvui.vn/<?=$data['head']['ogimage']?>"/>
