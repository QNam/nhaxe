<?php
                     ...
                     * @File /data/www/superweb/fe/tmp/themes/19//common/global_css.php
...
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main.css?v=5.3">
<?php if($web['anvui_id'] == 'TC0A31qrgPVJBW3a') { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/24/statics/css/style4.css?v=7.7">
<?php } else { ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style4.css?v=7.8">
<?php } ?>

<?php if($web['anvui_id'] == 'TC0BO1rObet9WJXn' || $web['anvui_id'] == 'TC0Ah1r7aBgqH7jX' || $web['anvui_id'] == 'TC0A31qrgPVJBW3a' || $web['anvui_id'] == 'TC1OHntfnujP' || $web['anvui_id'] == 'TC0Ba1rTOa1WJOCp' || $web['anvui_id'] == 'TC0Cn1rx2Fp3dumx' || $web['anvui_id'] == 'TC04r1lru1vOk3c' || $web['anvui_id'] == 'TC0DB1s6aI4FE4mP' || $web['anvui_id'] == 'TC0821q4JlOdY2Tz' || $web['anvui_id'] == 'TC0Dy1sPqJsYVkgG') { ?>

<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/main3.css?v=11.9">

<?php } ?>
<link rel="stylesheet" href="<?=$web['static_temp']?>/<?=$web['temp']?>/statics/css/style5.css?v=10.2">
...
.main-bg-vn {
    ...
    /* background-image: url(../images/hero-images/vn-03.jpg); */
...
.search-mask[data-target=homepage] .search-mask__submit {
    float: left;
    margin-top: 43px;
}
.form__field.form__field--1-3 label {
    font-weight: bold;
    color: #00305b;
    margin-top: 5px;
    margin-bottom: 15px;
...
<?php if($web['anvui_id'] == 'TC0Dy1sPqJsYVkgG') { ?>
<style type="text/css">
footer, .thongke {
