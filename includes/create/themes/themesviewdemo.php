    ...
    <head>
       <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1"/>
         <title><?php echo $_DATA['viewdemo']['title']; ?></title>
            ...
            <div class="demo-header">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-4 text-right" style="line-height: 40px;">
                        ...
                        <?php } else {?>
                                  <a href="javascript:" class="hidden-xs btn-registration banner-home-registration event-Template-apply-form-open">Vui lòng liên hệ tới 1900 1911</a>
                        <?php } ?>
