...
<head>
    <meta charset="UTF-8">
     ...
     <title>Phần mềm nhà xe - <? if(!empty($_DATA['detail'])) {  echo $_DATA['detail']['title']; } ?></title>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 wow bounceInLeft data-wow-duration="0.5s" data-wow-delay="0.4s"">
                    <div class="modal_box">
                        ...
                        <div class="modal_info">
                            ...
                            <?php if(number_format($_DATA['detail']['price'], 0, ',', '.')==0){ ?>
                            <p><a href="http://nhaxe.vn/?temp=<?php echo $_DATA['detail']['sub_id']; ?>" class="modal_use_tempale">Sử dụng giao diện này</a></p>
                            <?php } else {?>
                                 <p><a href="javascript:" class="modal_use_tempale"> Vui lòng liên hệ tới 1900 1911</a></p>
                            <?php } ?>     
                        ...
                        <div class="modal_contact">
                            <p>Bạn còn thắc mắc, vui lòng liên hệ <span class="modal_contact_phone">1900 1911</span><br />
                            Hoặc: </p>
                        </div>
                    </div>
               </div>
