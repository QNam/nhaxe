        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="logo">
                        <h1><a href="http://themes.webbnc.net/<?php echo $_DATA['link_svg']; ?>" title="BNC_Group"><img src="/includes/create/themes//themesstore/images/logo2.png" alt="Anvui"></a></h1>
                    </div>  
                </div>
                <!-- End Logo -->
                <!-- Menu Mobile -->
                  ...
                  <div class="container">
                    ...
                    <div id="navbar" class="collapse navbar-collapse sidebar-offcanvas">
                      <ul class="nav navbar-nav">
                            ...
                            <li><a href="" target="_blank">Bảng giá</a></li>
