...
if ($action == 'index') {
    ...
    foreach ($themes_new as &$v) {
        $v['link'] = 'http://nhaxe.vn/themesview-' . fixTitle($v['title'])  . $v['id'] . '.html'.$link_svg;
        unset($v);
    }
    ...
    foreach ($category as &$value) {
        $value['link'] = 'http://nhaxe.vn/themesstore-' . fixTitle($value['title'])  . $value['id'] . '.html'.$link_svg;
        unset($value);
    }
    ...
    $_B['static']          = 'http://nhaxe.vn/includes/create/themes';
