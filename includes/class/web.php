...
class Web {
    ...
    private function get_info_web() {
        ...
        $this->info['ssl']    = false;
        if ($this->idw == 3789 || $this->idw == 4678 || $this->idw == 5547 || $this->idw == 5624 || $this->idw == 2829 || $this->idw == 3567 || $this->idw == 3569 || $this->idw == 3577 || $this->idw == 3634 || $this->idw == 3658) {
            $this->info['ssl'] = true;
        }
        ...
        if (isset($cf['themes_custom']) && $cf['themes_custom'] == 1) {
            ...
            $this->info['tempvx']      = $this->info['id_term_vx'];
            $this->info['video_info']      = $this->info['video_info'];
            $this->info['link_fanpage']      = $this->info['link_fanpage'];
        }
