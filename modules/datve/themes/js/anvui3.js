...
function selectTripOneWay(trip) {
    ...
    var appendDatve = '<div id="select-seat-oneway">';
        ...
        appendDatve +='</div>';           
        appendDatve +='</div>';  
        appendDatve +='<div class="detail-review"><div class="col-md-4 col-lg-4 col-xs-12 col-sm-4  detail-total"><div class="col-md-12 col-xs-12" style="min-height: 25px; padding: 0px;"><span style="float: left;">Số ghế:</span><b style="float: right;"><span class="seatlist" id="ghedi">Vui lòng chọn ít nhất một chỗ ngồi</span></b></div><div class="col-md-12 col-xs-12" style="padding: 0px;"><span style="float: left;">Tổng tiền:</span><div style="float: right;"><span class="seat-template-old-total-fare" style="font-size: 14px; text-decoration: line-through; margin-right: 10px;"></span><h4 class="seat-template-total-fare amount" style="font-size: 20px; color: red;"><strong id="totalMoney">0</strong></h4></div></div></div><div class="col-md-4 col-lg-4 detail-review-route"><div class="col-md-12 col-xs-12" style="min-height: 25px; padding: 0px;"><span style="float: left;">Điểm đi:</span><b class="rv-tran-from">07 Phạm Văn Đồng, Cầu Giấy, Hà Nội</b></div><div class="col-md-12 col-xs-12" style="min-height: 25px; padding: 0px;"><span style="float: left;">Điểm đến:</span><b class="rv-tran-to">333 Phố Mới, Lào Cai, Lào Cai</b></div></div><div class="column-butom col-md-4 col-lg-4 col-xs-12"><div class="form-group mb0"><div class="hidden-lg hidden-md hidden-sm fix-review-price-mobi" style="bottom: 72px;"><div class="btn-vxr-back">Quay lại</div><button type="button" class="cont-btn btn-vxr-continue-no-seat"><!-- react-text: 17352 -->Tiếp tục <!-- /react-text --><i class="glyphicon glyphicon-chevron-right f14"></i></button></div><div class="col-md-12 col-sm-12 cont-container text-center hidden-xs"><button type="button" class="cont-btn btn btn-vxr-lg btn-vxr-lg-action"><!-- react-text: 17356 -->Đặt chỗ <!-- /react-text --><i class="glyphicon glyphicon-chevron-right f14"></i></button></div></div></div></div>';         
        appendDatve +='</div>';   
        ...
        success: function (result) {
            ...
            $.each(result, function (key, item) {
                ...
                if(isBack) {
                    ...
                    var schedule = '<li class=" '+typeclass+' scheduleId-'+item.scheduleId+' "  > <div class="container"> ';
                } else {
                    var schedule = '<li class=" '+typeclass+' scheduleId-'+item.scheduleId+' " >';
                }
