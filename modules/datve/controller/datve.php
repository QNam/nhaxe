...
//			 die;
	...
	function orderNew(){
		...
		$rt = $this->PostAnvuiCus('https://ticket-new-dot-dobody-anvui.appspot.com/ticket/book',$_POST);
	...
	function orderNewWb(){
		...
		$rt = $this->PostAnvuiCus('https://nha-tau-an-vui.appspot.com/ticket/book',$_POST);
