...
Class Bussanbay extends Controller {
	public function index() {

		// ?startPoint=Sân+bay+Vân+Đồn&endPoint=Công+viên+hoa+Hạ+Long+-+Lán+Bè&depatureDate=31%2F12%2F2018&returnDate=&startId=P08G1q9nLiAxeSf&routeIdd=R08G1q9q2hIeqJj&endId=P08G1q9n7TYZABv
		global $web; 
...
//            echo "error";exit();
    	...
    	$dz['companyId'] = $web['anvui_id'];
		$time_seat = $this->PostAnvuiCus('https://dobody-anvui.appspot.com/company/view',$dz);

		$data['timeBookHolder'] = $time_seat['results']['company']['timeBookHolder'];
	...
	function order(){
		...
		$rt = $this->PostAnvuiCus('https://dobody-anvui.appspot.com/general_ticket/create',$_POST);
