                    ...
                    success: function (data) {
                        ...
                        if(data.code != 200) {
                            ...
                            if(paymentType == 1) {
                                ...
                                var a = "https://test-dot-dobody-anvui.appspot.com/momo/pay?packageName=web&ticketId="+data.results.ticket.ticketId+"&companyId="+companyId;
...
function selectTripOneWay(trip) {
    ...
    var appendDatve = '<div id="select-seat-oneway">';
        ...
        if(companyId != 'TC08T1qEunQgs8rW'){
            ...
            appendDatve +='<label class="radio">Thanh toán qua MOMO<input type="radio"  class="paymenttype" name="paymenttype" value="7"><span class="checkround"></span></label>';           
        ...
        if(companyId === "TC08T1qEunQgs8rW" ){
            appendDatve +='<label class="radio">Thanh toán tại quầy<input type="radio" id = "tttq" checked="checked" class="paymenttype" name="paymenttype" value="5"><span class="checkround"></span><p>Quý khách vui lòng thanh toán vào Số tài khoản: <br>19020330434017 <br>Chủ tài khoản: Võ Thuý Vi<br>Mở tại Ngân hàng Techcombank - PGD Phú Thọ<br>Nội dung : Tên & sdt<br>để được nhà xe ưu tiên giữ chỗ</p></label>';           
