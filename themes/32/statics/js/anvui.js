...
function selectTripOneWay(trip) {
    ...
    if(companyId === 'TC0A31qrgPVJBW3a' || companyId === 'TC09m1ql1mnbOd5x' || companyId === 'TC05wM7dDRQSo6' || companyId === 'TC0Ah1r7bCvzRlpF'){
       htmlThanhtoanmgp = '<label class="radio">Thanh toán trực tuyến (ATM/Visa/Master/JCB..) <input type="radio" checked="checked" class="paymenttype" name="paymenttype" value="8"><span class="checkround"></span></label>'; 
    }
