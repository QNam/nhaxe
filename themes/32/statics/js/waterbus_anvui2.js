...
function selectTripOneWay(trip) {
    ...
    }else if(companyId === 'TC0761phLM2cBJrc' || companyId === 'TC0Bi1rWXg3hO6JR' || companyId === 'TCO_Rjp8OCmQa' || companyId === 'TC0DB1s6aI4FE4mP' || companyId == 'TC1OHntfnujP' || companyId == 'TC0Bp1rZFPJNRYty' || companyId == 'TC04r1lru1vOk3c' || companyId == 'TC0Cm1rweVdinjJi'){
        htmlThanhtoanmgpv = '';
    }else{
    ...
    if(companyId === 'TC0761phLM2cBJrc' || companyId === 'TC0AU1r2R982ex93' || companyId === 'TC0Bi1rWXg3hO6JR'  || companyId ==  'TCO_Rjp8OCmQa' || companyId == 'TC0DB1s6aI4FE4mP' || companyId == 'TC1OHntfnujP' || companyId == 'TC0Bp1rZFPJNRYty' || companyId == 'TC0Cm1rweVdinjJi'){
    ...
    if(companyId === 'TC0Ah1r7bCvzRlpF'){
        ...
        appendDatve +='<div class="col-md-12"><input autocomplete="off" class="col-md-5 form-control" id="promotionCode" style="width: auto;" type="text" placeholder="Mã khuyến mại"><button type="button" class="btn btn-info col-md-4" id="checkPromotion" onclick="checkPromotion()">Kiểm tra</button></div>';
        appendDatve +='</div>';
    ...
    }else if(companyId === 'TC0CK1rlUyn1qquy'){
        var appendDatve = '<div id="select-seat-oneway">';
        appendDatve +='<div class="col-md-8">';
        appendDatve +='<div class="row">';
        appendDatve +='<div class="col-md-6">';
        ...
        appendDatve +='<div class="col-md-12"><label for="phoneNumber" style="display: none;">Email</label><input type="email" placeholder="Email" class="form-control" name="email" id="email"></div>';
        appendDatve +='<div class="col-md-12"><label for="phoneNumber" style="display: none;">Ghi chú</label><textarea placeholder="Các yêu cầu đặc biệt không thể được đảm bảo nhưng nhà xe sẽ cố gắng hết sức để đáp ứng yêu cầu của bạn" name="note" class="form-control" id="note" rows="3"></textarea></div>';
        appendDatve +='<div class="col-md-12"><input autocomplete="off" class="col-md-5 form-control" id="promotionCode" style="width: 70%; border-radius: 0px; float:left;" type="text" placeholder="Mã khuyến mại"><button type="button" class="btn btn-info col-md-4" id="checkPromotion" style="width:30%;height: 40px;font-size: 13px;" onclick="checkPromotion()">Kiểm tra</button></div>';
        appendDatve +='</div>';
...
function getSchedule(startPoint, endPoint, date, isBack) {
    ...
    $.ajax({
        type: "POST",
        url: "https://www.anvui.vn/listScheduleNhaTau",
        data: {
        ...
        success: function (result) {
            ...
            $.each(result['trips'], function (key, item) {
                ...
                schedule += ' <div class="hidden-xs"> <div class="offer-container hidden-sm hidden-xs"><div class="container-fluid payoo-offer-container"> <div class="row" style="display:none;"> <div class="col-sm-4 col-xs-3 pd-0 mb10" style="width:auto"> <div class="offer-tag">Loại xe</div></div><div class="col-sm-10 col-xs-10 pd-0 ml20" style="margin-top:2px;"> <span></span> <span class="noti-detail" style="cursor:pointer;color:#1867bc"> '+ item.vehicleTypeName +' </span> </div></div><div class="pop-vxr w300 payoo-offer-tip" style="display: none;"> <div class="body-pop"> <div> <p style="line-height: 20px;white-space: pre-line;"></p></div></div></div></div></div><div class="col-2 col-md-3 col-sm-3 col-xs-2"> <div class="row"> <div class="pull-left comp-name-container"> <h6>'+item.pointUp.name+' - '+item.pointDown.name +'</h6> </div></div></div><div class="col-4 col-md-6 col-lg-5 col-sm-3 col-xs-4 detail-route"> <div class="col-12 ml10" style="text-align:center;"> <div class="text-left-from" style="display:inline-block"> <h6>'+ msToTime(item.startTime) +'</h6> </div><div class="text-left" style="padding:0; display:inline-block; margin-left:5px; margin-right:5px;"> - </div><div class="text-left-to" style="display:inline-block"> <h6 class="startDate">'+depatureDate+'</h6> </div><div class="clearfix"></div><div class="pull-left hidden-sm" style="width:100%;"> <div class="col-5 col-md-5 col-sm-5"> <a></a> </div><div class="col-2 col-md-2 col-sm-2"></div><div class="col-5 col-md-5 col-sm-5 payoo-mt2"> <a></a> </div></div></div></div><div class="col-2 col-md-2 col-sm-3 col-xs-2" style="text-align:center"> <div style="margin-bottom:3px !important" ></div><div class="clearfix"></div><div class="service-call seats-text mt15" style=""> <span>' +item.totalEmptySeat+ '</span> Ghế trống </div> <div class="service-call seats-text mt15" style=""> <span>Loại xe: ' +item.seatMap.seatMapName+ '</span> </div></div><div class="text-right pr0 col-md-3 col-sm-3 col-xs-2 col-lg-2"><h6 > '+ ticketPrice3 +' <small style="vertical-align: top;" class="unit-price-small">đ</small> </h6> <p style="margin:0;"> <div class="ticket-ac-btn btn-vxr-lg btn pull-right w100 hasSeat closed " onclick="selectTripOneWay(this)" ' +
                        'data-ratio="' + 1 + '" ' +
