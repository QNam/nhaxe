...
$(document).ready(function () {
    ...
    // $.ajax({
    //     type: 'POST',
    //     url: 'https://ticket-dot-dobody-anvui.appspot.com/point/get_province_and_point',
    //     dataType: "json",
        ...
        // if(response.length > 0) {
            ...
            if(isRound == 0){
                ...
                $.each(seatOneway , function(index, val) { 
                    informationsBySeats.push({'seatId': val, 'fullName': fullName, 'phoneNumber': phoneNumber, 'isAdult': true, 'mealPrice': 0, 'insurancePrice': 0, "extraPrice": 0,"agencyPrice": ticketPriceOneway,"isTransshipment": false,
...
function selectTripOneWay(trip) {
    ...
    if(companyId == 'TC0Ah1r7bCvzRlpF'){
        if( sumdatenowSelect - startdateSelect <= 0 && sumtimestartSelect - sumtimenowSelect <= 100){
            showTransshipment = 'hide'
            console.log(sumdatenowSelect);
            console.log(startdateSelect);
            console.log(sumtimestartSelect - sumtimenowSelect);
        }
        ...
        appendDatve +='<label class="radio">Thanh toán qua megapay <input type="radio" checked="checked" class="paymenttype" name="paymenttype" value="8"><span class="checkround"></span></label>';           
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result['trips'], function (key, item) {
                ...
                schedule += ' <div class="hidden-xs"> <div class="offer-container hidden-sm hidden-xs"><div class="container-fluid payoo-offer-container"> <div class="row" style="display:none;"> <div class="col-sm-4 col-xs-3 pd-0 mb10" style="width:auto"> <div class="offer-tag">Loại xe</div></div><div class="col-sm-10 col-xs-10 pd-0 ml20" style="margin-top:2px;"> <span></span> <span class="noti-detail" style="cursor:pointer;color:#1867bc"> '+ item.vehicleTypeName +' </span> </div></div><div class="pop-vxr w300 payoo-offer-tip" style="display: none;"> <div class="body-pop"> <div> <p style="line-height: 20px;white-space: pre-line;"></p></div></div></div></div></div><div class="col-2 col-md-3 col-sm-3 col-xs-2"> <div class="row"> <div class="pull-left comp-name-container"> <h6>'+item.pointUp.name+' - '+item.pointDown.name +'</h6> </div></div></div><div class="col-4 col-md-6 col-lg-5 col-sm-3 col-xs-4 detail-route"> <div class="col-12 ml10" style="text-align:center;"> <div class="col-5 col-md-5 col-sm-12 text-left-from"> <h6>'+ msToTime(item.startTime) +'</h6> </div><div class="col-1 col-md-1 col-sm-12 text-left" style="padding:0;"> - </div><div class="col-5 col-md-5 col-sm-12 text-left-to"> <h6 class="startDate">'+depatureDate+'</h6> </div><div class="clearfix"></div><div class="pull-left hidden-sm" style="width:100%;"> <div class="col-5 col-md-5 col-sm-5"> <a></a> </div><div class="col-2 col-md-2 col-sm-2"></div><div class="col-5 col-md-5 col-sm-5 payoo-mt2"> <a></a> </div></div></div></div><div class="col-2 col-md-2 col-sm-3 col-xs-2" style="text-align:center"> <div style="margin-bottom:3px !important" ></div><div class="clearfix"></div><div class="service-call seats-text mt15" style=""> <span>' +item.totalSeat+ '</span> Ghế trống </div></div><div class="text-right pr0 col-md-3 col-sm-3 col-xs-2 col-lg-2"><h6 > '+ ticketPrice2 +' <small style="vertical-align: top;" class="unit-price-small">đ</small> </h6> <p style="margin:0;"> <div class="ticket-ac-btn btn-vxr-lg btn pull-right w100 hasSeat closed " onclick="selectTripOneWay(this)" ' +
                        'data-ratio="' + 1 + '" ' +
