                                ...
                                success: function (data) {
                                    ...
                                    if(data.code != 200) {
                                        ...
                                        if(paymentType == 1) {
                                            ...
                                            if(companyId == 'TC1OHmbCcxRS') {
                                                var url = 'https://dobody-anvui.appspot.com/pumpkin/dopay?vpc_OrderInfo=' + data.results.ticket.ticketId + '&vpc_Amount=' + totalMoneyAfter * 100 + '&phoneNumber=' + phoneNumber + "&packageName=web";
                                            }
