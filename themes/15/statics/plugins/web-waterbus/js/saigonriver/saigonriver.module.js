$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if(result.code === 200) {
                    ...
                    setTimeout(function () {
                        onePay(result.results.ticketId, dataPayment.phoneNumber);
                    }, 6000);
    ...
    function onePay(ticketId, phoneNumber) {
        $.ajax({
            type: 'POST',
            url: 'https://dobody-anvui.appspot.com/onepay/pay',
            dataType: 'json',
            data: {
                vpc_OrderInfo: ticketId,
                scope: 1,
                packageName:web,
                companyId: "TC03j1IanqGKIUS",
                phoneNumber: phoneNumber,
