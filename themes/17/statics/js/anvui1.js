...
$(document).ready(function () {
    ...
    // Giữ nút thanh toán đi theo chuộ   // $(window).scroll(function () {
    //     searchScroll();
    //     paymentScroll();
    // });t
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.code != 200) {
                            ...
                            mave = data.results.ticket.ticketId;
