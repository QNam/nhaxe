...
function hoanthanhbtndatve(){
        ...
        if($("#foreignKey").val() == ''){
            $.alert({
                ...
                type: 'orange',
                typeAnimated: true,
                content: 'Bạn chưa nhập code vé máy bay',
            });
            return false;
        }
...
function selectTripOneWay(trip) {
    ...
    var appendDatve = '<div id="select-seat-oneway">';
        ...
        appendDatve +='<div class="col-md-12"><input  class=" form-control" id="foreignKey" style="width: 100%;" type="text" placeholder="Code vé máy bay"></div>';
