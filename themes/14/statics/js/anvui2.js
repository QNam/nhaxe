                        ...
                        if(data.code != 202) {
                            ...
                            setTimeout(function() {
                                if(paymentType == 1) {
                                    ...
                                    var a = "https://ticket-dot-dobody-anvui.appspot.com/onepay/pay?vpc_OrderInfo=" + ticketIdNew + "&vpc_Amount=" + (100 * totalMoneyAfter + ((totalMoneyAfter * 0.01)*100 + 1000*100)) + "&phoneNumber=" + phoneNumber + "&packageName=web";
...
function selectTripOneWay(trip) {
    ...
    if(companyId === 'TC0A31qrgPVJBW3a' || companyId === 'TC0BA1rJ3ah7wdMl' ||  companyId === 'TC0Ah1r7bCvzRlpF' || companyId === 'TC0B31rGICznLw9n' || companyId === 'TC0BS1rQHdJWRYKG' || companyId === 'TC0BD1rKFD9ZDxmu' || companyId === 'TC05wM7dDRQSo6' ||  companyId === 'TCO_Rjp8OCmQa' || companyId === 'TC0CJ1rlCZVe5Vrl' || companyId == 'TC0Cu1rzpoTq3vbZ'){
    ...
    }else if(companyId === 'TC0761phLM2cBJrc' || companyId === 'TC0Bi1rWXg3hO6JR'  || companyId === 'TC0DB1s6aI4FE4mP' || companyId == 'TC1OHntfnujP' || companyId == 'TC0Bp1rZFPJNRYty' || companyId == 'TC04r1lru1vOk3c' || companyId == 'TC0Cm1rweVdinjJi' || companyId == 'TC09m1ql1mnbOd5x' || companyId == 'TC0Cn1rx2Fp3dumx' || companyId == 'TC0Cu1rzpoTq3vbZ' || companyId == 'TC0CJ1rlCZVe5Vrl'){
        htmlThanhtoanmgpv = '';
    }else{
    ...
    if(companyId === 'TC08Z1qHHZBxlNLt'){
        htmlThanhtoanOnePay = '<label class="radio">Thanh toán qua OnePay<input type="radio"  class="paymenttype" name="paymenttype" value="2"><span class="checkround"></span></label>'
    }




    if(companyId === 'TC0761phLM2cBJrc' || companyId === 'TC0AU1r2R982ex93' || companyId === 'TC0Bi1rWXg3hO6JR'  || companyId == 'TC0DB1s6aI4FE4mP' || companyId == 'TC1OHntfnujP' || companyId == 'TC0Bp1rZFPJNRYty' || companyId == 'TC0Cm1rweVdinjJi' || companyId == 'TC0Cn1rx2Fp3dumx' || companyId == 'TC09m1ql1mnbOd5x' || companyId == 'TC0Cu1rzpoTq3vbZ'){
    ...
    if(companyId === 'TC0Ah1r7bCvzRlpF'){
        ...
        appendDatve +='<div class="col-md-12"><input autocomplete="off" class="col-md-5 form-control" id="promotionCode" style="width: auto;" type="text" placeholder="Mã khuyến mại"><button type="button" class="btn btn-info col-md-3" id="checkPromotion" onclick="checkPromotion()">Kiểm tra</button></div>';
        appendDatve +='</div>';

        appendDatve +='<div class="detail-customer-info '+showTransshipment+'">';
        ...
        appendDatve += '<div class="col-md-12"><label >Nhập điểm đón</label><input  name="transshipmentInPointOnewayd" class="form-control" id="transshipmentInPointOnewayd" ></div>';
        appendDatve += '<div class="col-md-12"><label >Nhập điểm trung chuyển trả</label><input  name="transshipmentOffPointOnewayd" class="form-control" id="transshipmentOffPointOnewayd" ></div>';
        appendDatve +='</div>';
        appendDatve +='</div>';
        ...
        // appendDatve +='<label class="radio">Thanh toán qua MegaV<input type="radio"  class="paymenttype" name="paymenttype" value="1"><span class="checkround"></span></label>';                    
        ...
        appendDatve +='<label class="radio cltttq">Thanh toán tại quầy<input type="radio" class="paymenttype" name="paymenttype" value="5"><span class="checkround"></span></label>';           
        appendDatve +='<p class="timeBook">Hệ thống sẽ tự động hủy vé nếu sau  '+timeBookHolder+' phút bạn không thanh toán tiền </p>';           
    ...
    }else if(companyId === 'TC0CK1rlUyn1qquysdf'){
        var appendDatve = '<div id="select-seat-oneway">';
        appendDatve +='<div class="col-md-8">';
        appendDatve +='<div class="row">';
        appendDatve +='<div class="col-md-6">';
        ...
        appendDatve +='<div class="content-boxd" style="display:none;">';
        appendDatve += '<div class="col-md-12"><label >Nhập điểm đón</label><input  name="transshipmentInPointOnewayd" class="form-control" id="transshipmentInPointOnewayd" ></div>';
        appendDatve += '<div class="col-md-12"><label >Nhập điểm trả</label><input  name="transshipmentOffPointOnewayd" class="form-control" id="transshipmentOffPointOnewayd" ></div>';
        appendDatve +='</div>';
        ...
        appendDatve +='<!--<label class="radio">Thanh toán bằng thẻ quốc tế--><!--<input type="radio" class="paymenttype" name="paymenttype" value="2">--><!--<span class="checkround"></span>--><!--</label>-->';           
        appendDatve +='<label class="radio">Thanh toán tại quầy<input type="radio" class="paymenttype" name="paymenttype" value="5"><span class="checkround"></span></label>';           
        appendDatve +='<p class="timeBook">Hệ thống sẽ tự động hủy vé nếu sau  '+timeBookHolder+' phút bạn không thanh toán tiền </p>';           
        appendDatve +='<label class="radio" id="radiochuyenkhoan" style="display: none">Chuyển khoản <input type="radio" class="paymenttype" name="paymenttype" value="6"><span class="checkround"></span></label>';           
        appendDatve +='</div>';           
        appendDatve +='<center><button type="button" id="hoanthanhbtn" class="btn" onclick="hoanthanhbtndatve(this)" >Xác nhận đặt vé </button><button type="button" style="display: none" id="btnchuyenkhoan" class="btn" data-toggle="modal" data-target="#chuyenkhoan">Thông tin chuyển khoản</button></center>';           
        ...
        appendDatve +='</div>'; 
        appendDatve +='</div>'; 
    } else if(companyId == 'TC0Bi1rWXg3hO6JR'){
        var appendDatve = '<div id="select-seat-oneway">';
        appendDatve +='<div class="col-md-8">';
        appendDatve +='<div class="row">';
        appendDatve +='<div class="col-md-6">';
        ...
        appendDatve +='<div class="col-md-12"><label for="phoneNumber" style="display: none;">Email</label><input type="email" placeholder="Email" class="form-control" name="email" id="email"></div>';
        appendDatve +='<div class="col-md-12"><label for="phoneNumber" style="display: none;">Ghi chú</label><textarea placeholder="Các yêu cầu đặc biệt không thể được đảm bảo nhưng nhà xe sẽ cố gắng hết sức để đáp ứng yêu cầu của bạn" name="note" class="form-control" id="note" rows="3"></textarea></div>';
        appendDatve +='<div class="col-md-12"><input autocomplete="off" class="col-md-5 form-control" id="promotionCode" style="width: 70%; border-radius: 0px; float:left;" type="text" placeholder="Mã khuyến mại"><button type="button" class="btn btn-info col-md-3" id="checkPromotion" style="width:30%; height: 46px;" onclick="checkPromotion()">Kiểm tra</button></div>';
        appendDatve +='</div>';

        appendDatve +='<div class="detail-customer-info '+showTransshipment+'">';
        appendDatve +='<label class="container-checkbox" for="transshipment">Đón trả tại trung chuyển';
        appendDatve +='<input type="checkbox" id="transshipment">';
        appendDatve +='<span class="checkmark"></span>';
        appendDatve +='</label>';

        appendDatve +='<label class="container-checkbox" for="transshipmentAddress">Đón trả tại nhà';
        appendDatve +='<input type="checkbox" id="transshipmentAddress">';
        appendDatve +='<span class="checkmark"></span>';
        appendDatve +='</label>';


        appendDatve +='<label class="container-checkbox" for="transshipmentAddressB">Đón trả bến';
        appendDatve +='<input type="checkbox" id="transshipmentAddressB">';
        appendDatve +='<span class="checkmark"></span>';
        appendDatve +='</label>';
        ...
        appendDatve += '<div class="content-boxd-address" style="display:none">';
        appendDatve += '<div class="row">';
        appendDatve += '<div class="col-md-12">';
        appendDatve += '<input type="email" placeholder="Điểm đón tại nhà" class="form-control" name="inAddressTranshipment" id="inAddressTranshipment">';
        appendDatve += '</div>';
        appendDatve += '<div class="col-md-12">';
        appendDatve += '<input type="email" placeholder="Điểm trả tại nhà" class="form-control" name="offAddressTranshipment" id="offAddressTranshipment">';
        appendDatve += '</div>';
        appendDatve += '</div>';
        appendDatve += '</div>';
        ...
        appendDatve +='<div class="radio">';   
        appendDatve +='<div>'+htmlThanhtoanmgp+'</div>'; 
        appendDatve +='<div>'+htmlThanhtoanmgpv+'</div>'; 
        appendDatve +='<div>'+htmlThanhtoanOnePay+'</div>'; 

        appendDatve +='<div>'+htmlChuyenKhoan+'</div>'; 
    ...
    if(addPri.length > 0){
        var i;
        for (i = 0; i < addPri.length; i++) {
            $.each(addPri[i].listUserType, function (key, val) {
        
            if(val === 2){
                if(addPri[i].type===2){
                    ticketPriceOneway = ticketPriceOneway + addPri[i].mode * addPri[i].amount * ticketPriceOneway;
                }else{
                    ticketPriceOneway = ticketPriceOneway + addPri[i].mode * addPri[i].amount;
                }
                return true;
            } else{
                return false;
...
function xacnhan(seat, isBaby, isBack) {
    ...
    if(!isBack) {
        ...
        var extraPriceNew = seat.extraPrice;
        if(addPri.length > 0){
            ...
            console.log(extraPriceNew,'extraPriceNewd');
        } else {
            extraPriceNew = seat.extraPrice
        }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if(result['trips'].toString() !== '') {
                ...
                if(companyId == 'TC0Cn1rx2Fp3dumx'){
                    $.alert({
                        title: 'Thông báo!',
                        type: 'red',
                        typeAnimated: true,
                        content: 'Đang cập nhật xe Vui lòng liên hệ HOTLINE: 0287.300.7073 && 1900 636349'
                    });
                }
                else if(companyId == 'TC0Cm1rweVdinjJi'){
                    $.alert({
                        title: 'Thông báo!',
                        type: 'red',
                        typeAnimated: true,
                        content: '<div class=""><img src ="https://xechatluongcaosontung.vn/themes//14/statics/imgs/thong-bao.jpg"/></div>'
                    });
            ...
            $.each(result['trips'], function (key, item) {
                ...
                ticketPriceRoot = item.price;
                if(item.additionPriceForUserType.length > 0){
                    var i;
                    for (i = 0; i < item.additionPriceForUserType.length; i++) {
                        $.each(item.additionPriceForUserType[i].listUserType, function (key, val) {
                    
                            if(val === 2){
                                if(item.additionPriceForUserType[i].type===2){
                                    ticketPrice2 = item.price + item.additionPriceForUserType[i].mode * item.additionPriceForUserType[i].amount * item.price;
                                }else{
                                    ticketPrice2 = item.price + item.additionPriceForUserType[i].mode * item.additionPriceForUserType[i].amount;
                                }
                                return true;
                            } else{
                                return false;
                ...
                if(companyId === 'TC0Cu1rzpoTq3vbZ' || companyId === 'TC09m1ql1mnbOd5x'){
                   var textPrice = 'Giá Vé Từ :'; 
                }else{
                    var textPrice = ''
                }
                ...
                schedule += ' <div class="hidden-xs"> <div class="offer-container hidden-sm hidden-xs"><div class="container-fluid payoo-offer-container"> <div class="row" style="display:none;"> <div class="col-sm-4 col-xs-3 pd-0 mb10" style="width:auto"> <div class="offer-tag">Loại xe</div></div><div class="col-sm-10 col-xs-10 pd-0 ml20" style="margin-top:2px;"> <span></span> <span class="noti-detail" style="cursor:pointer;color:#1867bc"> '+ item.vehicleTypeName +' </span> </div></div><div class="pop-vxr w300 payoo-offer-tip" style="display: none;"> <div class="body-pop"> <div> <p style="line-height: 20px;white-space: pre-line;"></p></div></div></div></div></div><div class="col-2 col-md-3 col-sm-3 col-xs-2"> <div class="row"> <div class="pull-left comp-name-container"> <h6>'+item.pointUp.name+' - '+item.pointDown.name +'</h6> </div></div></div><div class="col-md-4 col-sm-3 col-xs-4 detail-route"> <div class="col-12 ml10" style="text-align:center;"> <div class="text-left-from" style="display:inline-block"> <h6>'+ msToTime(item.startTime) +'</h6> </div><div class="text-left" style="padding:0; display:inline-block; margin-left:5px; margin-right:5px;"> - </div><div class="text-left-to" style="display:inline-block"> <h6 class="startDate">'+depatureDate+'</h6> </div><div class="clearfix"></div><div class="pull-left hidden-sm" style="width:100%;"> <div class="col-5 col-md-5 col-sm-5"> <a></a> </div><div class="col-2 col-md-2 col-sm-2"></div><div class="col-5 col-md-5 col-sm-5 payoo-mt2"> <a></a> </div></div></div></div><div class="col-2 col-md-2 col-sm-3 col-xs-2" style="text-align:center"> <div style="margin-bottom:3px !important" ></div><div class="clearfix"></div><div class="service-call seats-text mt15" style=""> <span>' +item.totalEmptySeat+ '</span> Ghế trống </div> <div class="service-call seats-text mt15" style=""> <span>Loại xe: ' +item.seatMap.seatMapName+ '</span> </div></div><div class="text-right pr0 col-md-3 col-sm-3 col-xs-2 col-lg-2"><h6 > <span class="tp">' + textPrice + ' </span> ' + ticketPrice3  +' <small style="vertical-align: top;" class="unit-price-small">đ</small> </h6></div><div class="col-md-1"> <p style="margin:0;"> <div class="ticket-ac-btn btn-vxr-lg btn pull-right w100 hasSeat closed " onclick="selectTripOneWay(this)" ' +
                        'data-ratio="' + 1 + '" ' +
                        ...
                        'data-price="' + item.price + '"><p style="display:none" class="additonPriceInfo">'+JSON.stringify(additionPrice)+'</p><p style="display:none" class="seatMap">'+JSON.stringify(item.seatMap)+'</p><p style="display:none" class="pointUp">'+JSON.stringify(item.pointUp)+'</p><p style="display:none" class="pointDown">'+JSON.stringify(item.pointDown)+'</p>Chọn </div> </div><div class="col-12 col-md-12 col-lg-12 col-sm-12 col-xs-12">  </div></div><div class="hidden-lg hidden-sm hidden-md"> <div class="col-xs-12"> <div class="row"> <div class="offer-container hidden-sm hidden-xs"> <div class="container-fluid payoo-offer-container"> <div class="row"> <div class="col-sm-4 col-xs-3 pd-0 mb10" style="width:auto"> <div class="offer-tag">Loại xe</div></div><div class="col-sm-10 col-xs-10 pd-0 ml20" style="margin-top:2px;"> <span>'+ item.seatMap.seatMapName +'</span> <span class="noti-detail" style="cursor:pointer;color:#1867bc"> </span> </div></div><div class="pop-vxr w300 payoo-offer-tip" style="display: none;"> <div class="body-pop"> <div> <p style="line-height: 20px;white-space: pre-line;"></p></div></div></div></div></div><div class="offer-container hidden-lg hidden-md"> <div class="container-fluid payoo-offer-container"> <div class="row"> <div class="col-sm-4 col-xs-3" style="width:auto"> <div class="offer-tag">Loại xe</div></div><div class="col-sm-7 col-xs-8 pd-0" style="margin-top:2px;"> <span class="noti-detail">'+ item.seatMap.seatMapName +'</span> </div></div><div class="pop-vxr w300 payoo-offer-tip" style="display: none;"> <div class="body-pop"> <div> <p style="line-height: 20px;white-space: pre-line;"></p></div></div></div></div></div></div><div class="row"> <div class="col-xs-7"> <div class="star-mobile"> <h6> '+ depatureDate +' - '+ msToTime(item.startTime) +' </h6> <i class="pl5 pr5 text-gray3 left-arrow">→</i> <h6>  </h6> </div></div><div class="col-xs-5 text-right"> <h6> <span class="tp">' + textPrice + ' </span> ' + ticketPrice3 +' <small style="vertical-align: top;" class="unit-price-small">đ</small> </h6> </div></div><div class="row"> <div class="col-xs-6"> <h6 class="comp-name-title text-gray3">'+item.route.name+'</h6> </div><div class="col-xs-6 text-right"> <p> <span>' +item.totalEmptySeat+ '</span> Ghế trống </p></div></div><div class="row"> <div class="col-xs-6"> <div class="text-gray vehicle-type-p mb3 hidden-lg hidden-md"> '+item.pointUp.name+' → '+item.pointDown.name+' </div></div></div><div class="row"> <div class="col-xs-6"> <div class="text-gray vehicle-type-p mb3 hidden-lg hidden-md"></div></div><div class="col-xs-6 text-right"> <p style="margin:0;"> <div class="ticket-ac-btn btn-vxr-lg btn pull-right w100 hasSeat closed " onclick="selectTripOneWay(this)" ' +
                        'data-ratio="' + 1 + '" ' +
                        'data-activeDxb= "'+daxuatben+'"'+
                        'data-getinpoint="' + item.getInPointId + '"' +
                        'data-getoffpoint="' + item.getOffPointId + '"' +
...
$('body').on('change','#transshipment',function () {
    if($(this).is(':checked')) {
        ...
        $("#transshipmentAddress").prop('checked', false);
        $("#transshipmentAddressB").prop('checked', false);
        $(".content-boxd").show();
        $(".content-boxd-address").hide();
    } else {
        transshipment = 0;
        if(totalMoneyOneway > 0) {
            totalMoneyOneway -= trashipmentPriceOneway;
...
$('body').on('change','#transshipmentAddress',function () {
    if($(this).is(':checked')) {
        $(".content-boxd-address").show();
        $(".content-boxd").hide();
        $("#transshipment").prop('checked', false);
        $("#transshipmentAddressB").prop('checked', false);
...
$('body').on('change','#transshipmentAddressB',function () {
    if($(this).is(':checked')) {
