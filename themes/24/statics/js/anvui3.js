...
function selectTripOneWay(trip) {
    ...
    var appendDatve = '<div id="select-seat-oneway">';
        ...
        appendDatve +='<ul class="chuthich"><li><div class="ghetrong"></div> Ghế trống</li><li><div class="ghedachon"></div> Ghế đã chọn</li><li><div class="ghedaban"></div> Ghế đã bán</li></ul>';
        ...
        appendDatve +='<div class="col-md-12" style="display: none;"><label for="phoneNumber" style="display: none;">Email</label><input type="email" placeholder="Email" class="form-control" name="email" id="email"></div>';
        ...
        appendDatve +='<label class="container-checkbox" for="transshipment" style="display:none">Đón tận nơi - Trả tận nơi';
        appendDatve +='<input type="checkbox" id="transshipment">';
        appendDatve +='<span class="checkmark"></span>';
        appendDatve +='</label>';
        appendDatve +='<div class="content-boxd">';
        ...
        appendDatve +='<label for="transshipmentInPointOneway">Nhập điểm đón </label>';
        appendDatve +='<input class="form-control" name="pickUpAddress" placeholder="Nhập điểm đón" id="pickUpAddress"/>';
        appendDatve +='</div>';
        appendDatve +='</div>';
        appendDatve +='</div>';
        appendDatve +='<div id="toend" class="tab-pane active in">';
        appendDatve +='<div class="">';
        appendDatve +='<label for="transshipmentOffPointOneway">Nhập điểm trả </label>';
        appendDatve +='<input class="form-control" name="dropOffAddress" placeholder="Nhập điểm trả" id="dropOffAddress"/>';
        appendDatve +='</div>';
        appendDatve +='</div>';
        appendDatve +='</div>';
        ...
        appendDatve +='<div class="col-md-12">Giá ghế: <span class="price" id="adultMoneyOneway">0 VND</span> <br></div>';
        appendDatve +='<div class="col-md-12" style="display:none;">Giá trẻ em: <span class="price" id="babyMoneyOneWay">0 VND</span> <br></div>';
        appendDatve +='</div>';
        appendDatve +='<div class="subtotal">Tổng tiền lượt đi<strong id="totalMoneyOneway">0 VND</strong></div>';
        appendDatve +='<div class="col-md-12" style="display:none;">Phí trung chuyển: <span class="price" id="transshipmentPriceOneway">0 VND</span> <br></div>';
        appendDatve +='</div>';
        ...
        appendDatve +='<label class="radio">Thanh toán trên xe<input type="radio" class="paymenttype" name="paymenttype" value="5"><span class="checkround"></span></label>';     
        appendDatve +='<p style="    color: #c00;font-style: italic;">Quý khách vui lòng thanh toán trong vòng '+timeBookHolder+' phút, sau '+timeBookHolder+' phút hệ thống sẽ tự động hủy vé</p>';      
