                    ...
                    success: function (data) {
                        ...
                        if(data.code != 200) {
                            ...
                            if(paymentType == 1 ) {
                                ...
                                var a = "https://dobody-anvui.appspot.com/inter-payment/dopay?vpc_OrderInfo=" + data.results.ticket.ticketId + "&vpc_Amount=" + (100 * totalMoneyAfter + ((totalMoneyAfter * 0.01)*100 + 1000*100)) + "&phoneNumber=" + phoneNumber + "&packageName=web";
                                window.location.href = a
                                ...
                                $.ajax({
                                  url: 'https://dobody-anvui.appspot.com/banks',
                                  type: 'GET',
                                  ...
                                  success: function(result) {
                                    ...
                                    $("#hoanthanhQrCode").click(function(){
                                        ...
                                        var url = 'https://dobody-anvui.appspot.com/vnp/pay?vnp_OrderInfo='+data.results.ticket.ticketId+'&packageName=web&bankCode='+bankCode+'&companyId='+companyId;
